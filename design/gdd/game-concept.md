...
> 보육원을 퇴소한 청년이 100만원 시드머니로 투자 대회에 도전하는 실시간 투자 시뮬레이션.
> 기업 정보를 읽고, 차트를 분석하고, 시장 뉴스에 반응하며 매매 판단을 내려
> 수익을 복리로 불려가며 시즌 1등을 향해 성장하는 게임.
...
투자 대회 1등을 쟁취하는 경험. 100만원으로 시작해 수익을 복리로 불려가며
1억을 향해 나아간다. 플레이어는 "나는 시장을 읽을 수 있다"는 유능감과
"100만원에서 1억까지 올라왔다"는 성취감을 동시에 느낀다.
...
| **Fantasy** (make-believe, role-playing) | 2 | 100만원에서 1억까지, 보육원 퇴소 청년의 투자 성장 판타지 |
...
- **Recovery from failure**: 시즌 내 손실은 회복 가능 (대회 끝날 때까지 기회 있음). 손실이 나도 스킬은 영구 유지, 다음 시즌 상금으로 자본 회복 가능
