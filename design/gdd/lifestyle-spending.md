...
exit_multiplier:
  ...
  # C등급 (도박형)
  grade == "C":
    IPO (randf() < 0.30):          randf_range(5.0, 10.0)  # 30%
    M&A (randf() < 0.50):          randf_range(0.8, 1.2)   # 20% (=0.50-0.30)
    폐업 (그 외):                  0.0                      # 50%
...
- C등급: 0.30×7.5 + 0.20×1.0 + 0.50×0 = 2.25 + 0.20 = **2.45× (분산 매우 높음)**
