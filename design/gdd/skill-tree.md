...
| ID | Tier | 스킬명 | 효과 | 선행 조건 |
|----|------|--------|------|-----------|
| S0 | T0 | 뉴스 (30초 딜레이) | 뉴스 30초 후 수신 | 기본 제공 |
| S1 | T1 | 빠른 뉴스 | 뉴스 딜레이 15초로 단축 | — |
...
| 해금 상태 | 딜레이 (틱) | 실시간 환산 |
|-----------|-----------|------------|
| S0 (기본) | 40틱 (게임시간 10분) | 약 7.7초 (40×0.192) at 1x |
| S1 | 20틱 (게임시간 5분) | 약 3.8초 (20×0.192) at 1x |
| S2 | 0틱 | 즉시 |
...
| NEWS_DELAY_T0 | 40틱 (게임 10분, 실시간 ~7.7초) | 20~60 | 초기 정보 불이익 크기 | 너무 크면 뉴스 시스템 무용 |
| NEWS_DELAY_T1 | 20틱 (게임 5분, 실시간 ~3.8초) | 10~30 | S1 해금 가치 | T0과 차이 적으면 해금 동기 부족 |
...
| AC-6 | 뉴스 딜레이가 스킬에 따라 변경됨 | 유닛 테스트: S0→40틱, S1→20틱, S2→0틱 |
