...
- [ ] 세이브 → 종료 → 로드 → 재개가 E2E로 동작한다 (XP/레벨/스킬/시즌 상태 복원)
- [ ] 주문 체결·레벨업·VI 발동·뉴스 알림 4개 SFX 인게임 발동 확인
- [ ] 최초 실행 시 인트로 서사 5장 카드가 표시된다
- [ ] AI 티어 파라미터가 "티어 = 자본, 실력 ≠ 티어" 모델로 조정된다 ✅ (2026-04-06 완료)
...
|---|--------|--------|--------|
| A-01 | 세이브/로드 시스템 | Sprint 5 | 🔲 Not Started |
| A-02 | 오디오 기반 (AudioManager + SFX 4종) | Sprint 5 | 🔲 Not Started |
| A-03 | 인트로 서사 (슬라이드 카드 5장) | Sprint 5 | 🔲 Not Started |
...
| ID | 내용 | Sprint | Status |
|----|------|--------|--------|
| TD-S5-03 | 차트 RSI/MACD 배열 재할당 제거 | Sprint 5 | 🔲 Not Started |
| TD-S5-04 | 로컬라이제이션 기반 tr() 래핑 | Sprint 5 | 🔲 Not Started |
...
- [ ] 테스트: 전체 pass (기존 192 + 신규)
- [ ] 최초 실행 → 인트로 → 1시즌 플레이 → 저장 → 재로드 E2E 수동 통과
- [ ] QA Lead 서명
