...
> **Target**: 2026-05-21 (Sprint 10 종료 — 3주로 확장, 이월 없음)
...
- [x] UI 실 에셋 완성 (spinner_ring SVG 연결 완료 — start_bg 불필요 판정, 내러티브 디렉터 확인)
...
| B-07b | TR3 공매도 GDD + 구현 | Sprint 9 | ✅ Done (2026-04-20 — ShortSellingSystem, MIN_MARGIN_RATE=1.20) |
| B-07c | TR4 레버리지 GDD + 구현 | Sprint 9 | ✅ Done (2026-04-20 — LeverageManager, F2b 이자 원금화, 마진콜 팝업) |
| B-08 | P3 섹터 ETF GDD + 구현 (A4 섹터 비교 포함) | Sprint 10 | ✅ Done (2026-04-20 — EtfManager, SectorComparisonView, MarketProfile) |
| B-09 | 설정 화면 (볼륨·접근성·키 리맵·뉴스 자동 감속 On/Off) | Sprint 9 | ✅ Done (2026-04-23) |
| B-10 | UI 실 에셋 완성 (spinner_ring) | Sprint 9 | ✅ Done (2026-04-17 — saving_overlay.gd TextureRect 연결. start_bg 불필요 판정) |
...
| B-13 | 수익 실현 팡파레 (`profit-celebration.md` Draft) — GDD 완성 + 이펙트 4등급 구현 | Sprint 10 | ✅ Done (2026-04-23) |
...
|--------|------|--------|-----------|
| 7 | 2026-04-14 ~ 2026-04-15 | TR2 + F3 성장화면 | S6-07이월(TR2 GDD) + B-01(TR2 구현) + B-03(F3 GDD+구현) + B-04(Phase3 스킬 UI) |
| 8 | 2026-04-15 ~ 2026-04-17 | A3 + S3 루머 + 오더북 + 라이프스타일 | B-06(A3 재무제표) + B-07a(S3 루머) + B-11(오더북) + B-12(라이프스타일) + B-02(주거시각화, Should Have) |
| 9 | 2026-04-17 ~ 2026-04-30 | TR3 + TR4 + 설정화면 + OHLCV 누적 | B-07b(TR3 공매도) + B-07c(TR4 레버리지) + B-09(설정화면) + TD-HIST-01(주봉/월봉 선행) |
| 10 | 2026-05-01 ~ 2026-05-21 | P3/A4 + 팡파레 + GDD 구현 + Beta 마감 | B-08(A4 섹터비교+P3 섹터ETF) + B-13(팡파레) + TR4 레버리지 UI + FinancialReport Phase1 + MarketProfile DLC + GDD 업데이트 구현 전체 + 유닛테스트/fixture/GDD Approved + 3시즌 E2E QA + Beta DoD 정리 (이월 없음) |
...
> - 2026-04-17: Sprint 7·8 계획 대비 약 2주 조기 완료 → Sprint 9 시작일 2026-05-13 → 2026-04-17, Sprint 10 시작일 2026-05-27 → 2026-05-01로 앞당김. TD-HIST-01(OHLCV 시즌 간 누적) Sprint 9 Should Have 편입 (주봉/월봉 차트 구현 선행 조건).
>
