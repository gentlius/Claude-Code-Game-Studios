...
| B-02 | A-05a/b 주거 아트 + 시각화 시스템 | Sprint 8 (Should Have) | 📋 Planned (아트 에셋 2026-04-15 수령 완료 ✅) |
...
| B-12 | 라이프스타일 소비 시스템 (`lifestyle-spending.md` In Review) — LifestyleManager 구현 + 오프시즌 화면 | Sprint 8 | 📋 Planned (아트 에셋 수령으로 선행 조건 충족) |
