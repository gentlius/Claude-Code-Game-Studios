...
|--------|------|--------|-----------|
| 7 | 2026-04-15 ~ 2026-04-16 | TR2 + F3 성장화면 | S6-07이월(TR2 GDD) + B-01(TR2 구현) + B-03(F3 GDD+구현) + B-04(Phase3 스킬 UI) |
| 8 | 2026-04-16 ~ 2026-04-17 | A3 + S3 루머 + 오더북 + 라이프스타일 | B-06(A3 재무제표) + B-07a(S3 루머) + B-11(오더북) + B-12(라이프스타일) + B-02(주거시각화, Should Have) |
