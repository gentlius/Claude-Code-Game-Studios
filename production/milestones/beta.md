...
| B-02 | A-05a/b 주거 아트 + 시각화 시스템 | Sprint 10 | 📋 Planned (아트 에셋 사용자 작업 조건) |
...
| 9 | 2026-05-13 ~ 2026-05-26 | TR3 + TR4 | B-07b(TR3 공매도) + B-07c(TR4 레버리지) |
| 10 | 2026-05-27 ~ 2026-06-09 | P3 + Beta 마감 | B-08(P3 섹터ETF) + 3시즌 E2E QA + Beta DoD 정리 |

> **조건부 항목**: B-02(주거시각화), B-05(코어 SFX), B-10(UI 에셋)은 사용자 자산 수령 즉시 해당 스프린트에 편입.
