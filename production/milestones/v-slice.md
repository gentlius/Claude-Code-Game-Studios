...
|---|--------|-------------|------------|--------|--------|
| 9 | 경험치 시스템 | S (1.5 sessions) | MVP 완료 | Sprint 1 | ⬜ |
| 8 | 스킬 트리 | M (2 sessions) | 경험치 | Sprint 1 | ⬜ (GDD Approved) |
| 7 | AI 경쟁자 | M (2-3 sessions) | MVP 완료 | Sprint 2 | ⬜ |
...
| 시장 지수 HUD 표시 | `get_market_index()` API → 상단 상태바 연결 | Sprint 1 | ⬜ UI 잔여 |
| GUT 테스트 설치 | 유닛 테스트 자동 실행 환경 구축 | Sprint 1 | ✅ Done |
| 섹터/종목 확장 (46종목 11섹터) | V-Slice 데이터 기반. GDD+코드+테���트 | Sprint 1 | ✅ Done (unplanned) |
