...
|---|--------|-------------|------------|--------|--------|
| 9 | 경험치 시스템 | S (1.5 sessions) | MVP 완료 | Sprint 1 | ✅ Done (GDD+코드+테���트) |
| 8 | 스킬 트리 | M (2 sessions) | 경험�� | Sprint 1 | ✅ Done (GDD+코드+테스트) |
| 7 | AI 경쟁자 | M (2-3 sessions) | MVP 완료 | Sprint 2 | ✅ Done (GDD+코드+테스트) |
| 10 | 시즌/대회 관리 | M (2-3 sessions) | AI 경쟁자 | Sprint 2 | ✅ Done (GDD+코드+테스트) |
| 16 | 리더보드 UI | S (1 session) | 시즌/대회 | Sprint 3 | ✅ Done (GDD+코드) |
