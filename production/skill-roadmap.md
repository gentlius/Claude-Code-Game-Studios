...
| ID | 스킬명 | 브랜치 | 게임플레이 | UI 피드백 | 전반적 상태 |
|----|--------|--------|-----------|----------|------------|
| A1 | 이동평균선 | Analysis | Done | Done | Complete |
| A2 | 보조지표 (RSI/MACD) | Analysis | Not Built | Not Built | Not Started |
| A3 | 재무제표 (PER/PBR/ROE) | Analysis | Not Built | Not Built | Not Started |
| A4 | 섹터 비교 분석 | Analysis | Not Built | Not Built | Not Started |
| S1 | 빠른 뉴스 | Sense | Done | Missing | Gameplay-Only |
| S2 | 실시간 뉴스 | Sense | Done | Missing | Gameplay-Only |
| S3 | 루머 채널 | Sense | Stub Only | Missing | Not Started |
| TR1 | 지정가 주문 | Trading | Done (ungated) | Ungated | Gate Missing |
| TR2 | 손절/익절 | Trading | Not Built | Not Built | Not Started |
| TR3 | 공매도 | Trading | Stub Only | Missing | Not Started |
| TR4 | 레버리지 | Trading | Stub Only | Missing | Not Started |
| P1 | 5종목 보유 | Portfolio | Done | Missing | Gameplay-Only |
| P2 | 10종목 보유 | Portfolio | Done | Missing | Gameplay-Only |
| P3 | 섹터 ETF | Portfolio | Not Built | Not Built | Not Started |
...
|--------|-----------|----------|----------|
| Phase 1 | S1, S2, P1, P2, TR1 (gate) | 5 × S | 이미 작동하는 기능을 플레이어가 느끼게 만든다 |
