...
func test_limit_order_rejected_bad_tick_size() -> void:
	...
	var order: Dictionary = OrderEngine.submit_limit_order("BUY", "KF", 1, 65030)
...
func test_limit_order_accepted_valid_tick_size() -> void:
	...
	var order: Dictionary = OrderEngine.submit_limit_order("BUY", "KF", 1, 65000)
...
func test_limit_order_tick_size_low_price() -> void:
	...
	var order: Dictionary = OrderEngine.submit_limit_order("BUY", "KF", 1, 3003)
...
func test_limit_order_tick_size_boundary() -> void:
	...
	var order: Dictionary = OrderEngine.submit_limit_order("BUY", "KF", 1, 5000)
